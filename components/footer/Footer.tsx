...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-700 py-6 mt-140">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-around items-center">
        

        {/* Navigation Links */}
        <div className="flex space-x-6 mb-4 md:mb-0">
          <Link href="/privacy" className="text-[#7b6e5d] hover:text-[#6f4e37]">Privacy</Link>
          <Link href="/terms" className="text-[#7b6e5d] hover:text-[#6f4e37]">Terms</Link>
